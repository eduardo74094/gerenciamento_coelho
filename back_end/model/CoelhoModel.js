...
async updateCoelho(id, coelho) {
    const sql = (
"UPDATE coelho SET nome_coelho=$1, raca_coelho=$2, data_nascimento_coelho=$3, sexo_coelho=$4, observacoes_coelho=$5, peso_nascimento=$6, peso_atual=$7, tipo_coelho=$8, data_desmame=$9, peso_desmame=$10, matriz_coelho=$11, reprodutor_coelho=$12, situacao_coelho=$13, transferido_coelho=$14 WHERE id_coelho=$15 RETURNING *"
    );
